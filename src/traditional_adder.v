...
module traditional_adder (
	...
	input	  cin;
	input	[no_of_digits-1:0]  dataa;
	input	[no_of_digits-1:0]  datab;
	output	  cout;
	output	[no_of_digits-1:0]  result;

	wire  sub_wire0;
	wire [no_of_digits-1:0] sub_wire1;
	wire  cout = sub_wire0;
	wire [no_of_digits-1:0] result = sub_wire1[no_of_digits-1:0];
	...
	defparam
		...
		LPM_ADD_SUB_component.lpm_width = no_of_digits;
