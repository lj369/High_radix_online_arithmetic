...
# ACDS 16.1 196 win32 2018.05.24.19:26:00
# ----------------------------------------
...
# ----------------------------------------
# If pll_250_50MHz is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_250_50MHz"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/jlian_temp_ws/quartus/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_250_50MHz.vo"
}
